  ...
  if (!lesson) {
    return (
      <section className="flex min-h-[calc(100dvh-6rem)] flex-col justify-center px-5 py-7 md:px-10">
        <div className="mx-auto w-full max-w-lg rounded-none border border-ink/20 bg-white p-6 text-center">
          ...
          <Link
            href="/learn"
            className="mt-5 flex h-14 w-full items-center justify-center rounded-none bg-ink px-5 text-base font-bold text-white"
          >
            返回课程地图
          </Link>
        </div>
